...
(async() => {
  ...
  await page2.goto("chrome://webrtc-internals");
  ...
  try {
    ...
    await page2._client.send('Page.setDownloadBehavior', {behavior: 'allow', downloadPath: '/'});
    await page2.bringToFront();
    await page2.waitFor('summary');
    await page2.click('summary');
    await page2.waitFor('button');
    await page2.click('button');
    await new Promise(done => setTimeout(done, 2000));
    await page2.screenshot({path: '/foto.png', fullPage: true});
